...
/* Supplier Master */
    if($action =='addSupplier'){
        ...
        $insSupplier = "INSERT INTO `supplier_master`(`supplier_name`,`vat`, `prod_id`, `contact_person`, `city`, `contactno`, `address`, `supplier_status`) VALUES ('".$data->name."','".$data->vat."','".$data->prod_id."','".$data->contactperson."','".$data->city."','".$data->contactno."','".$data->address."','active')";
